...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="<?php echo site_url('ci_gaji/form')  ?>"  class="form-horizontal" method="POST">
                        <div class="card-body">
                            <h4 class="card-title">Data Pegawai</h4>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nip</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="nip" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Password</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="lname" name="password" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Nama Pegawai</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="lname" name="nm_pegawai" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">Tempat Lahir</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="email1" name="tmp_lahir" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Tanggal Lahir</label>
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="cono1" name="tgl_lahir" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">Jenis Kelamin</label>
                                <div class="col-sm-9">
                                    <input type="radio" id="male" name="jekel" value="male">
                                    <label for="male">Laki-Laki</label>
                                    <input type="radio" id="female" name="jekel" value="female">
                            ...
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">Tanggal Masuk</label>
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="email1" name="tgl_masuk" placeholder="Tanggal Masuk">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">NO Rekening</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="email1" name="norek" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">Gaji Pokok</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="email1" name="g_pokok" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jabatan">
                                        <option value="jan">Eksekutif</option>
                                        <option value="jan">Guru</option>
                                        <option value="feb">Karyawan</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Pendidikan</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="email1" name="pendidikan" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Status Pegawai</label>
                                    <div class="col-sm-9">
                                        <select name="stat_pegawai" placeholder ="Pilih Status">
                                  ...
                                  <button type="button" style="position: right" class="btn btn-primary">Submit</button>
